      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-text-body">Projects</p>
              <p className="text-2xl font-semibold text-primary">{stats.overview.projects}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-text-body">Experiments</p>
              <p className="text-2xl font-semibold text-primary">{stats.overview.experiments}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-text-body">Spectra</p>
              <p className="text-2xl font-semibold text-primary">{stats.overview.spectra}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-text-body">Researchers</p>
              <p className="text-2xl font-semibold text-primary">{stats.overview.users}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-text-body">Avg. Yield</p>
              <p className="text-2xl font-semibold text-primary">{stats.overview.avgYield}%</p>
            </div>
          </div>
        </div>
      </div>
